...
impl<W: Write + Seek> Writer for IVFWriter<W> {
    ...
    fn write_rtp(&mut self, packet: &rtp::packet::Packet) -> Result<()> {
        ...
        // {
        //     println!(" aaa write_rtp: 111 111, seen_key_frame {}, is_key_frame {}, current_frame {}, is_partition_head {}", self.seen_key_frame, is_key_frame, self.current_frame.is_some(), depacketizer.is_partition_head(&packet.payload));
        //     return Ok(());
        // }
        ...
        println!(" aaa write_rtp: 111 222, seen_key_frame {}, is_key_frame {}, current_frame {}, is_partition_head {}", self.seen_key_frame, is_key_frame, self.current_frame.is_some(), depacketizer.is_partition_head(&packet.payload));
        ...
        println!(" aaa write_rtp: 444, len {}", frame_content.len());
